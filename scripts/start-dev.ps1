...
Start-Process powershell -ArgumentList @(
    "-NoExit",
    "-Command",
    "Set-Location '$apiDir'; Write-Host '  [API] Iniciando...' -ForegroundColor Cyan; dotnet run --launch-profile http --no-launch-profile"
) -WindowStyle Normal
...
Start-Process powershell -ArgumentList @(
    "-NoExit",
    "-Command",
    "Set-Location '$webDir'; Write-Host '  [WEB] Iniciando...' -ForegroundColor Cyan; dotnet run --launch-profile https"
) -WindowStyle Normal

# Aguarda o BFF iniciar
